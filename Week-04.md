...
```text
Console.Write() => เป็นคำสั่งให้แสดงตัวแปรและข้อความในบรรทัดเดียวกัน
Console.WriteLine() => เป็นคำสั่งให้แสดงตัวแปรและข้อความคละบรรทัด
...
```text
เป็นการใช้ตัวเลขตำแหน่ง Operator ในการแสดงผลตัว Operator
...
```text
ใช้ได้ เนื่องจากการเขียนโปรแกรมไม่จำเป็นต้องเรียง Operator แต่หากไม่มี Operator ในตำแหน่งที่เรียกก็จะไม่แสดงตัวแปร
